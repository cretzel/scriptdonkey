 ...
 * 
 */
public abstract class MyAbstractDefaultAjaxBehavior extends AbstractAjaxBehavior {
    private static final long serialVersionUID = 1L;

    /** reference to the default indicator gif file. */
    public static final ResourceReference INDICATOR = new PackageResourceReference(
            MyAbstractDefaultAjaxBehavior.class, "indicator.gif");
    ...
    private static final ResourceReference JAVASCRIPT_DEBUG = new JavaScriptResourceReference(
            MyAbstractDefaultAjaxBehavior.class, "wicket-ajax-debug.js");
...
//            response.renderJavaScriptReference(JAVASCRIPT_DEBUG);
    ...
    /**
     * @return an optional javascript expression that determines whether the
     *         request will actually execute (in form of return XXX;);
     */
     ...
     * {@link MyAbstractDefaultAjaxBehavior#getAjaxCallDecorator()}.
     * 
     * @param partialCall
    ...
    protected CharSequence generateCallbackScript(final CharSequence partialCall) {
        ...
        if (decorator != null) {
            success = decorator
                    .decorateOnSuccessScript(getComponent(), success);
        }
        ...
        if (decorator != null) {
            failure = decorator
                    .decorateOnFailureScript(getComponent(), failure);
        }
     ...
     */
    public static CharSequence throttleScript(final CharSequence script,
            final String throttleId, final Duration throttleDelay) {
