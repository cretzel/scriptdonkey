...
public class DonkeyModificationWatcher implements IModificationWatcher {
    /** logger */
     ...
     */
    public DonkeyModificationWatcher() {
    }
     ...
     */
    public DonkeyModificationWatcher(final Duration pollFrequency) {
        start(pollFrequency);
    }
