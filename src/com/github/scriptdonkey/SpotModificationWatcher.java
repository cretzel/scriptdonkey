...
public class SpotModificationWatcher implements IModificationWatcher {
    /** logger */
     ...
     */
    public SpotModificationWatcher() {
    }
     ...
     */
    public SpotModificationWatcher(final Duration pollFrequency) {
        start(pollFrequency);
    }
